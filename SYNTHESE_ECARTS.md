...
|--------|-------------------------|
| **Maille IRIS / quartiers** | **992 IRIS officiels + indicateurs natifs** : DVF, recensement, Filosofi, logement et arbres. Aucune recopie arrondissement pour les indicateurs indisponibles. |
...
| **Tuiles vectorielles** | 20 arrondissements + 992 IRIS en GeoJSON sur fond OSM raster ; pas de Martin/tippecanoe (hors périmètre). |
...
| Maille IRIS | **Fait** (contours, navigation et indicateurs natifs disponibles) | — |
...
> Urban Data Explorer livre une chaîne data complète sur Paris, avec exploration par arrondissement ou IRIS : collecte open data, lake Medallion, géocodage, sync PostgreSQL/MongoDB, API et dashboard. Les limites — absence de source IRIS pour loyers, délinquance, pollution, transports et santé, millésime INSEE 2021 — sont assumées et visibles dans l'interface.
